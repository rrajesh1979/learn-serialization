...
public class UserService {
  ...
  public interface Iface {
    ...
    public UserResource get(int id) throws InvalidOperationException, org.apache.thrift.TException;

    public void save(UserResource resource) throws InvalidOperationException, org.apache.thrift.TException;

    public java.util.List<UserResource> getList() throws InvalidOperationException, org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void get(int id, org.apache.thrift.async.AsyncMethodCallback<UserResource> resultHandler) throws org.apache.thrift.TException;

    public void save(UserResource resource, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException;

    public void getList(org.apache.thrift.async.AsyncMethodCallback<java.util.List<UserResource>> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public UserResource recv_get() throws InvalidOperationException, org.apache.thrift.TException
    {
    ...
    public void send_save(UserResource resource) throws org.apache.thrift.TException
    {
    ...
    public java.util.List<UserResource> recv_getList() throws InvalidOperationException, org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class get_call extends org.apache.thrift.async.TAsyncMethodCall<UserResource> {
      private int id;
      public get_call(int id, org.apache.thrift.async.AsyncMethodCallback<UserResource> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
      ...
      public UserResource getResult() throws InvalidOperationException, org.apache.thrift.TException {
    ...
    public static class getList_call extends org.apache.thrift.async.TAsyncMethodCall<java.util.List<UserResource>> {
      public getList_call(org.apache.thrift.async.AsyncMethodCallback<java.util.List<UserResource>> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
      }
      ...
      public java.util.List<UserResource> getResult() throws InvalidOperationException, org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new java.lang.IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class get<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, get_args, UserResource> {
      public get() {
        super("get");
      }
      ...
      public org.apache.thrift.async.AsyncMethodCallback<UserResource> getResultHandler(final org.apache.thrift.server.AbstractNonblockingServer.AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new org.apache.thrift.async.AsyncMethodCallback<UserResource>() { 
          public void onComplete(UserResource o) {
            get_result result = new get_result();
            result.success = o;
            try {
      ...
      public void start(I iface, get_args args, org.apache.thrift.async.AsyncMethodCallback<UserResource> resultHandler) throws org.apache.thrift.TException {
    ...
    public static class getList<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getList_args, java.util.List<UserResource>> {
      public getList() {
        super("getList");
      }
      ...
      public org.apache.thrift.async.AsyncMethodCallback<java.util.List<UserResource>> getResultHandler(final org.apache.thrift.server.AbstractNonblockingServer.AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new org.apache.thrift.async.AsyncMethodCallback<java.util.List<UserResource>>() { 
          public void onComplete(java.util.List<UserResource> o) {
            getList_result result = new getList_result();
            result.success = o;
            try {
              fcall.sendResponse(fb, result, org.apache.thrift.protocol.TMessageType.REPLY,seqid);
      ...
      public void start(I iface, getList_args args, org.apache.thrift.async.AsyncMethodCallback<java.util.List<UserResource>> resultHandler) throws org.apache.thrift.TException {
  ...
  public static class get_result implements org.apache.thrift.TBase<get_result, get_result._Fields>, java.io.Serializable, Cloneable, Comparable<get_result>   {
    ...
    public @org.apache.thrift.annotation.Nullable UserResource success; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, UserResource.class)));
    ...
    public get_result(get_result other) {
      if (other.isSetSuccess()) {
        this.success = new UserResource(other.success);
      }
      if (other.isSetE()) {
    ...
    @org.apache.thrift.annotation.Nullable
    public UserResource getSuccess() {
      return this.success;
    }

    public get_result setSuccess(@org.apache.thrift.annotation.Nullable UserResource success) {
      this.success = success;
      return this;
    }
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.success = new UserResource();
  ...
  public static class save_args implements org.apache.thrift.TBase<save_args, save_args._Fields>, java.io.Serializable, Cloneable, Comparable<save_args>   {
    ...
    public @org.apache.thrift.annotation.Nullable UserResource resource; // required
    ...
    public save_args(save_args other) {
      if (other.isSetResource()) {
        this.resource = new UserResource(other.resource);
      }
    }
    ...
    public save_args setResource(@org.apache.thrift.annotation.Nullable UserResource resource) {
      this.resource = resource;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
      ...
      case RESOURCE:
        if (value == null) {
          ...
          setResource((UserResource)value);
        }
        break;
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, save_args struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 1: // RESOURCE
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.resource = new UserResource();
...
;
  ...
  public static class getList_result implements org.apache.thrift.TBase<getList_result, getList_result._Fields>, java.io.Serializable, Cloneable, Comparable<getList_result>   {
    ...
    public @org.apache.thrift.annotation.Nullable java.util.List<UserResource> success; // required
    public @org.apache.thrift.annotation.Nullable InvalidOperationException e; // required
    ...
    public getList_result(
      java.util.List<UserResource> success,
      InvalidOperationException e)
    {
      this();
      this.success = success;
    ...
    public getList_result(getList_result other) {
      if (other.isSetSuccess()) {
        java.util.List<UserResource> __this__success = new java.util.ArrayList<UserResource>(other.success.size());
        for (UserResource other_element : other.success) {
          __this__success.add(new UserResource(other_element));
        }
    ...
    @org.apache.thrift.annotation.Nullable
    public java.util.Iterator<UserResource> getSuccessIterator() {
      return (this.success == null) ? null : this.success.iterator();
    }

    public void addToSuccess(UserResource elem) {
      if (this.success == null) {
        this.success = new java.util.ArrayList<UserResource>();
      }
      this.success.add(elem);
    }

    @org.apache.thrift.annotation.Nullable
    public java.util.List<UserResource> getSuccess() {
      return this.success;
    }

    public getList_result setSuccess(@org.apache.thrift.annotation.Nullable java.util.List<UserResource> success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((java.util.List<UserResource>)value);
        }
        break;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new java.util.ArrayList<UserResource>(_list0.size);
                  @org.apache.thrift.annotation.Nullable UserResource _elem1;
                  for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                  {
                    _elem1 = new UserResource();
                    _elem1.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getList_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (UserResource _iter3 : struct.success)
            {
              _iter3.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (UserResource _iter4 : struct.success)
            {
              _iter4.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new java.util.ArrayList<UserResource>(_list5.size);
            @org.apache.thrift.annotation.Nullable UserResource _elem6;
            for (int _i7 = 0; _i7 < _list5.size; ++_i7)
            {
              _elem6 = new UserResource();
              _elem6.read(iprot);
